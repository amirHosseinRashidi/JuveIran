...
public class UserArticlesRvAdapter extends RecyclerView.Adapter<UserArticlesRvAdapter.ViewHolder> {

    SharedPreferences userStats;
    private ArrayList<DatumUserArticles> shortArticles;
    private Context c;

    public UserArticlesRvAdapter(ArrayList<DatumUserArticles> arrayList, Context context) {
        this.shortArticles = arrayList;
        this.c = context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(c).inflate(R.layout.item_shortnews,parent,false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.tvWriter.setText(userStats.getString(SpGlobals.KEY_USER_NAME, ""));
        ...
        holder.imgShareIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Spanned shareMessage = Html.fromHtml(shortArticles.get(position).getText().replaceAll("-", " "));
